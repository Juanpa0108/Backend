...
import com.example.comerciantes_backend.service.ResumenEstablecimientosService;
...
@PatchMapping("/estado/{id}")
    ...
    private final ResumenEstablecimientosService resumenEstablecimientosService;

    public ComercianteController(ResumenEstablecimientosService resumenEstablecimientosService) {
        this.resumenEstablecimientosService = resumenEstablecimientosService;
    }

    @GetMapping("/resumen-establecimientos/{id}")
    public ResponseEntity<Map<String, Object>> obtenerResumenEstablecimientos(@PathVariable Long id) {
        Map<String, Object> resumen = resumenEstablecimientosService.obtenerResumenEstablecimientos(id);
